<template>
      ...
      <div class="card text-center">
        <div class="card-header text-left">
          <h6 style="text-align:center;"> Post of the day </h6>
        </div>
        <div class="card-header text-left">
          {{info2.title}} by <strong>{{ info2.email}}</strong>
        </div>
        <div class="card-body">
           <img class="card-img-top" :src="info2.url" alt="Maznusmo s unsplasha i bilo bi lijepo da napisemo cija je slika">
        </div>
...
export default {
  ...
  computed: {
    timeAgo () {
      return moment(this.info2.postedAt).fromNow()
